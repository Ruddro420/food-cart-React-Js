            ...
            <div>
                ...
                <div className="price-range flex">
                    <div className="minimum">
                        <input onChange={(e) => setMin(e.target.value)} className="wrounded" type="number" placeholder="Min" />
                    </div>
                    <div className="maximum ml-2">
                        <input onChange={(e) => setMax(e.target.value)} className="wrounded mr-5 rounded" type="number" placeholder="Max" />
                    </div>
                </div>
            </div>
            {/* Filter With Area */}
